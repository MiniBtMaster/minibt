...
class BtDatasSet(OrderedDict, OrderedAddict):
    ...
    def get_replay_data(self, index) -> dict[str, pd.DataFrame]:
...
#     def __init__(self, broker: Broker, maxsize=0):
#         super().__init__(maxsize)
#         self.broker = broker
#         self.history: Queue[OrderData] = Queue()
...
class Broker(Base):
    ...
    def __getmargin(self, price) -> float:
        """获取保证金"""
