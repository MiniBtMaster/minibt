...
from PySide6.QtWidgets import (QApplication, QSplitter, QWidget, QVBoxLayout, QSizePolicy,
                               QHBoxLayout, QAbstractItemView, QTableWidgetItem, QHeaderView,)
from PySide6.QtGui import QColor, QFont, QPainter, QIcon, QPen, QGuiApplication
from PySide6.QtCore import Qt, QSize, QTimer, QUrl, QObject, QThread, QMetaObject, QEvent, Signal
...
def get_chart_class():
    ...
    if ChartClass is None:
        ...
        # 先导入PySide6的QtWebEngineWidgets模块，确保使用的是PySide6
        from PySide6.QtWebEngineWidgets import QWebEngineView
        from PySide6.QtWebChannel import QWebChannel
        from PySide6.QtCore import Qt, QObject, Slot, QUrl, QTimer

        # 定义一个使用PySide6 QObject的Bridge类
        ...
        # 手动设置lightweight_charts.widgets模块的using_pyside6变量为True
        ...
        # 直接使用我们导入的PySide6模块，而不是让lightweight_charts.widgets模块自己导入
...
class PriceAlertSettingDialog(Dialog):
    ...
    """
    alertSettingsChanged = Signal(dict)
...
def main(strategies, period_milliseconds: int = 1000):
    try:
        ...
        # 先导入PySide6的所有必要模块，确保使用的是PySide6
        from PySide6.QtWebEngineWidgets import QWebEngineView
        from PySide6.QtWebChannel import QWebChannel
        from PySide6.QtCore import Qt, QObject, Slot, QUrl, QTimer
