...
class Config:
    def __init__(self, agent_class=None, env_class=None, env_args=None, cwd=None):
        ...
        self.actor_path = ""
        self.actor_name = ""
        self.Loss: partial | None = None
        self.Optim: partial | None = None
        self.LrScheduler: partial | None = None
        self.SWALR: partial | None = None
        self.swa_start_epoch_progress = 0.8
        self.Activation: partial | None = None
        self.add_layerNorm = True
        self.Norm: partial | None = None
        ...
        # 可选模式:
        #   "random":     在 [min_start_length, 2*min_start_length] 范围内随机
        #   "incremental": 从 min_start_length 开始，每次评估递增 1
        #   "fixed":      固定使用 min_start_length
        self.min_start_mode = "fixed"
