...
def get_data(obj=None) -> Union[pd.Series, pd.DataFrame]:
    # IndicatorClass->series,dataframe
    if hasattr(obj, '_df'):
        obj = obj._df
    # BtIndType,BtDataType->pd.Series,pd.DataFrame
    if hasattr(obj, '_df'):
        return obj._df
