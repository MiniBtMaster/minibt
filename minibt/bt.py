...
class Bt:
            ...
            async with api.register_update_notify() as update_chan:
                ...
                async for _ in update_chan:
                    ...
                    if strategy.is_changing:
                        ...
                        if strategy() and isplot and start:
    ...
    def _strategy_replay(self, **kwargs):
        ...
        # ---------------------- 主函数（修复CMD弹窗：去掉CREATE_NEW_CONSOLE） ----------------------
    ...
    def optstrategy(self, target: OPTTargetType = 'profit_ratio',
                    weights: float | tuple[float] = 1., opconfig: OPTConfigType = {}, op_method: OPTMethodType = 'optuna', show_bar=True, skip=False, **kwargs):
