...
class CCIStrategy(Strategy):
    def __init__(self):
        ...
        self.data = self.get_kline("SHFE.ag2609", data_length=1000, height=500)
...
class CMOStrategy(Strategy):
    def __init__(self):
        self.min_start_length = 300
        self.data = self.get_kline("SHFE.cu2609", data_length=1000, height=500)
        self.data1 = self.get_kline(
            "SHFE.ag2609", data_length=1000, height=500)
