...
class AgentBase:
    ...
    def __init__(self, net_dims: list[int], state_dim: int, action_dim: int, gpu_id: int = 0, args: Config = Config()):
        ...
        '''optimizer'''
        self.act_optimizer: th.optim.Optimizer | None = None  # 行为网络的优化器
        self.cri_optimizer: th.optim.Optimizer | None = None  # 评价网络的优化器
    ...
    def update_net(self, buffer: ReplayBuffer | tuple) -> tuple[float, ...]:
