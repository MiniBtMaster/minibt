...
class CoreFunc:
    ...
    def tqfunc_count(self, cond=None, length: int = 10, **kwargs):
    ...
    def tqfunc_exist(self, cond=None, length: int = 10, **kwargs):
        kwarg = self._get_column_(locals())
        return TqFunc.exist(**kwarg)

    def tqfunc_every(self, cond=None, length: int = 10, **kwargs):
        kwarg = self._get_column_(locals())
    ...
    def tqfunc_barlast(self, cond=None, **kwargs):
        kwarg = self._get_column_(locals())
    ...
    def tqfunc_cum_counts(self, cond=None, **kwargs):
        kwarg = self._get_column_(locals())
    ...
    def tqta_MIKE(self, n, **kwargs) -> pd.DataFrame:
