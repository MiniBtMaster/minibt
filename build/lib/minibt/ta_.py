...
class LazyImport:
    ...
    def sp(cls):
        ...
        if _sklearn_preprocessing is None:
            with model_lock:  # 确保多线程安全
                if _sklearn_preprocessing is None:  # 双重检查
                    try:
    ...
    def SignalFeatures(self):
        ...
        if _SignalFeatures is None:
            with model_lock:  # 确保多线程安全
                if _SignalFeatures is None:  # 双重检查
                    try:
