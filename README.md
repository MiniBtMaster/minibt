...
[![Version](https://img.shields.io/badge/version-1.2.6-green.svg)](https://github.com/MiniBtMaster/minibt)
...
minibt 依赖以下基础环境，建议使用 Python 3.12 及以上版本（推荐 3.12 - 3.13 系列），可通过 `python --version` 检查当前环境版本：
...
若输出 `1.2.6`（或对应版本号），且无导入错误，说明安装成功。
