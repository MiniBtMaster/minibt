...
class Strategy(Base, StrategyBase, metaclass=StrategyMeta):
    ...
    def set_model_params(
            ...
            min_start_mode: Literal["fixed", "random","incremental"]  = "fixed",
            **params):
        """## 配置强化学习模型参数并初始化训练环境
        ...
        Args:
            ...
            auto_process_features (bool, optional): 是否自动处理特征（归一化、异常值、PCA等）。默认为 True
            min_start_mode (str, optional): 最小回测长度模式。默认为 "fixed"
            **params: 其他关键字参数
