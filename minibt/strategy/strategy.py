...
class Strategy(Base, StrategyBase, metaclass=StrategyMeta):
    ...
    def __getattribute__(self, name) -> IndFrame | IndSeries | Line | KLine:
        ...
        # in_next_context = object.__getattribute__(self, "_in_next_context")
        # if in_next_context:
        #     names = object.__getattribute__(self, "_indicators_names")
        #     if name in names:
        #         dataset = object.__getattribute__(self, "_btindicatordataset")
        #         dataset.update_values()
